...
static void
test_valid_lru_cache_add_and_find_in_800_million_adds_and_finds(void)
{
	size_t i;
	size_t recent_key = 0;
	int32_t recent_val = 0;
...
int main()
{
	...
	RUN_TEST(test_valid_lru_cache_add_and_find_in_800_million_adds_and_finds);
	...
	printf("\nLRU cache total run time %lf seconds\n", time_taken);
